...
// }) => {
//   console.log('Coming Inside the Vimeo Browser sanity studio')
...
//         headers: {
//           Authorization: `Bearer 1277e061f2276dcdcff3c9a5bce1a1e6`,
//         },
//       })
          ...
          <Card padding={3} radius={2} shadow={1}>
            <Stack space={2}>
              ...
              <div style={{position: 'relative', paddingBottom: '56.25%', height: 0}}>
                <iframe
                  title={selectedVideo.name} // Add a unique title based on the video name
                  src={`https://player.vimeo.com/video/${selectedVideo._id}`}
